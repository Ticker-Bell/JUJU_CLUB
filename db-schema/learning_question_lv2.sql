...
INSERT INTO learning_question (lesson_id, question_id, question_text, options, answer)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '금리가 오르면 기업이 빌린 돈에 대한 이자 부담이 커져 최종 이익이 줄어듭니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '할인율은 금리와 동행하며, 미래 꿈을 먹고 사는 성장주에 치명적입니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '금리는 돈의 흐름을 결정하는 밸브 역할을 합니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '수출 기업은 원화 약세 시 가격 경쟁력이 높아지고 환차익을 얻습니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '외국인에게는 주가 수익률만큼 환율 변동이 중요합니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '환율은 국내 물가와 금리 정책에도 큰 영향을 줍니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', 'CPI가 예상보다 높으면 금리 인상 확률이 커져 주가에는 악재가 됩니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '성장은 없는데 비용(물가)만 오르는 기업에겐 최악의 시나리오입니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '비용 전가 능력이 있는 기업이 인플레이션에서 살아남습니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '제조업 중심인 우리나라는 경기 회복 시 산업재와 소재주가 강세를 보입니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '주식 시장은 미래를 선반영하는 거울과 같습니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '영원한 상승도, 영원한 하락도 없는 것이 자본주의의 사이클입니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '1년에 8번 열리는 FOMC 회의 결과는 전 세계 금융 시장의 향방을 가릅니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0), 'explanation', '시장에 돈이 마르면 주가에는 하락 압력으로 작용합니다.')
       );
...
VALUES (
           ...
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '돈은 이자가 높은 곳으로 흐르는 본능이 있습니다.')
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV2_CH009_LS004', 'LV2_CH009_LS004_Q005', 'LINK',
           ...
           JSON_ARRAY(
                   ...
                   JSON_OBJECT('correct', JSON_OBJECT('L1','R1', 'L2','R2', 'L3','R3', 'L4','R4'), 'explanation', '누가 주식을 움직이는지 알면 흔들리지 않습니다.'),
                   NULL
           );
