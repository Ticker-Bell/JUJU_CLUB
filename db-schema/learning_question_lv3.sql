...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH002_LS005', 'LV3_CH002_LS002_Q003', 'MATCH',
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH004_LS001', 'LV3_CH004_LS001_Q004', 'DRAG',
           '퀀트 투자 단계: 데이터 수집 → {{blank}} 선정 (지표 설정) → 전략 검증 (백테스팅) → {{blank}} 매매',
           JSON_OBJECT('choices', JSON_ARRAY('팩터(Factor)', '규칙 기반(Rule-based)', '시장 가 분석')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '좋은 지표를 고르고 이를 규칙에 따라 실행하는 과정입니다.'),
           NULL
       );
...
VALUES (
           ...
           JSON_ARRAY(
                   ...
                   JSON_OBJECT('correct', JSON_OBJECT('L1','R1', 'L2','R2', 'L3','R3', 'L4','R4'), 'explanation', '각 매매 방식의 장단점을 알고 내 성향에 맞는 것을 골라야 합니다.'),
                   NULL
           );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH004_LS002', 'LV3_CH004_LS002_Q004', 'DRAG',
           '가치 팩터와 퀄리티 팩터를 함께 사용하면 {{blank}} 수익률을 높이면서 {{blank}} 위험을 낮출 수 있습니다.',
           JSON_OBJECT('choices', JSON_ARRAY('기대', '하락', '과거')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '서로 다른 성격의 팩터를 섞으면 상호 보완 효과가 발생합니다.'),
           NULL
       );
...
VALUES (
           ...
           JSON_ARRAY(
                   ...
                   JSON_OBJECT('correct', JSON_OBJECT('L1','R1', 'L2','R2', 'L3','R3', 'L4','R4'), 'explanation', '팩터의 종류를 알아야 균형 잡힌 전략을 짤 수 있습니다.'),
                   NULL
           );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH004_LS003', 'LV3_CH004_LS003_Q004', 'DRAG',
           '모멘텀은 상승장에서는 강력한 수익을 주지만, 하락장으로 변하는 {{blank}} 구간에서는 {{blank}}가 클 수 있습니다.',
           JSON_OBJECT('choices', JSON_ARRAY('추세 전환', '변동성', '수익성')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '기세가 꺾이는 지점을 잘 포착하는 것이 모멘텀의 숙제입니다.'),
           NULL
       );

-- Q005. LINK: 팩터별 매수 타이밍
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_ARRAY(
                   ...
                   JSON_OBJECT('correct', JSON_OBJECT('L1','R1', 'L2','R2', 'L3','R3', 'L4','R4'), 'explanation', '각 팩터마다 주가가 오를 것이라고 기대하는 이유가 다릅니다.'),
                   NULL
           );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH004_LS004', 'LV3_CH004_LS004_Q004', 'DRAG',
           '신뢰할 수 있는 백테스팅을 위해서는 거래 {{blank}}와 {{blank}} 영향력을 반드시 포함하여 수익률을 보수적으로 잡아야 합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('수수료', '세금', '운')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '실제 매매 시 발생하는 비용은 수익률을 갉아먹는 핵심 요소입니다.'),
           NULL
       );

-- Q005. LINK: 백테스팅 용어 정리 (4개 선지)
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_ARRAY(
                   ...
                   JSON_OBJECT('correct', JSON_OBJECT('L1','R1', 'L2','R2', 'L3','R3', 'L4','R4'), 'explanation', '이 지표들을 종합적으로 분석해야 건강한 전략인지 알 수 있습니다.'),
                   NULL
           );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH004_LS005', 'LV3_CH004_LS005_Q004', 'DRAG',
           '위험 대비 수익률인 {{blank}} 지수가 높을수록 효율적인 전략이며, {{blank}}이 낮을수록 심리적으로 안정적인 투자가 가능합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('샤프(Sharpe)', 'MDD', '회전율')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '안정적이면서 수익성 높은 전략을 찾는 것이 퀀트의 목표입니다.'),
           NULL
       );

-- Q005. LINK: 리스크 관리 실전 전략 (4개 선지)
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH004_LS005', 'LV3_CH004_LS004_Q005', 'LINK',
           ...
           JSON_ARRAY(
                   ...
                   JSON_OBJECT('correct', JSON_OBJECT('L1','R1', 'L2','R2', 'L3','R3', 'L4','R4'), 'explanation', '시스템적으로 대응할 때 감정을 이길 수 있습니다.'),
                   NULL
           );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH005_LS001', 'LV3_CH005_LS001_Q004', 'DRAG',
           '투자자는 손실을 {{blank}}으로 보지 말고, 다음 기회를 위한 {{blank}}으로 프레이밍해야 합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('실패', '기회비용(매물 비용)', '운')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '관점을 바꾸는 것이 심리적 고통을 줄이는 기술입니다.'),
           NULL
       );

-- Q005. LINK: 상황별 심리 대응 (4개 선지)
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1','R1', 'L2','R2', 'L3','R3', 'L4','R4'), 'explanation', '심리를 통제하는 규칙이 곧 계좌를 지키는 법입니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH002_LS001', 'LV3_CH005_LS002_Q004', 'DRAG',
           '고급 투자자는 {{blank}}를 잊고 오직 해당 기업의 {{blank}} 가치에만 집중해야 합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('매수가', '현재', '과거')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '수익률 계산보다는 기업의 미래 가치 변화에 주목해야 합니다.'),
           NULL
       );

-- Q005. LINK: 앵커링 탈출 훈련 (4개 선지)
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '기준점을 외부에 두지 말고 자신의 원칙에 두어야 합니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH005_LS003', 'LV3_CH005_LS003_Q004', 'DRAG',
           '고급 투자자는 시장이 {{blank}}에 질렸을 때 용기를 내고, 시장이 {{blank}}에 가득 찼을 때 두려움을 느껴야 합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('공포', '탐욕', '기쁨')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '시장의 에너지가 한쪽 끝으로 쏠릴 때가 기회 혹은 위기입니다.'),
           NULL
       );

-- Q005. LINK: 시장 지표와 심리 해석
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '대중과 반대로 생각할 수 있는 용기가 부를 만듭니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH005_LS004', 'LV3_CH005_LS004_Q004', 'DRAG',
           '기록되지 않은 기억은 {{blank}}에 의해 미화되므로, 매매 직후의 {{blank}}를 기록하는 것이 성장의 핵심입니다.',
           JSON_OBJECT('choices', JSON_ARRAY('사후 확신', '근거와 심리', '수익률')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '기록은 과거의 나를 객관적으로 마주하게 해줍니다.'),
           NULL
       );

-- Q005. LINK: 편향 탈출을 위한 질문 (4개 선지)
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '질문의 날카로움이 실력을 만듭니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH005_LS005', 'LV3_CH005_LS005_Q004', 'DRAG',
           '고급 투자자는 자신의 {{blank}}을 믿기보다 미리 설정된 {{blank}} 매매를 통해 감정을 배제해야 합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('의지력', '예약(자동)', '직관')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '시스템은 지치지도, 흥분하지도 않습니다.'),
           NULL
       );

-- Q005. LINK: 멘탈 붕괴 징후와 처방
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '자신을 통제하는 것이 시장을 통제하는 것보다 쉽고 중요합니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH006_LS001', 'LV3_CH006_LS001_Q004', 'DRAG',
           '미래에 가격이 오를 것으로 보고 계약하는 것을 {{blank}} 포지션, 내릴 것으로 보고 계약하는 것을 {{blank}} 포지션이라고 합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('롱(Long)', '숏(Short)', '중립(Neutral)')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '선물은 하락에 베팅(숏)하여 수익을 낼 수 있다는 점이 큰 특징입니다.'),
           NULL
       );

-- Q005. LINK: 선물 용어 정리 (4개 선지)
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '전문 용어를 숙지해야 시장의 수급을 읽을 수 있습니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH006_LS002', 'LV3_CH006_LS002_Q004', 'DRAG',
           '옵션 {{blank}}자는 손실이 프리미엄으로 한정되지만, 옵션 {{blank}}자는 이론상 무한대의 손실 위험을 집니다.',
           JSON_OBJECT('choices', JSON_ARRAY('매수', '매도', '보유')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '매수자는 보험 가입자, 매도자는 보험사 역할을 하는 것과 같습니다.'),
           NULL
       );

-- Q005. LINK: 옵션 상황별 매매 판단
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '예측의 강도와 방향에 따라 옵션 포지션이 결정됩니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH006_LS003', 'LV3_CH006_LS003_Q004', 'DRAG',
           '공매도 순서: 주식 대여 → {{blank}} 매도 → 주가 하락 → {{blank}} (환매수) → 주식 상환',
           JSON_OBJECT('choices', JSON_ARRAY('고가', '숏 커버링', '저가')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '비싸게 팔고 싸게 사서 주식으로 갚는 과정입니다.'),
           NULL
       );

-- Q005. LINK: 매매 방향과 기대 심리
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '시장 상황에 따라 다양한 방향성을 선택할 수 있습니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH006_LS004', 'LV3_CH006_LS004_Q004', 'DRAG',
           '하락 위험을 완전히 고정하려면 {{blank}}를 활용하고, 상승 수익은 열어두되 하락만 막으려면 {{blank}}를 매수합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('지수 선물 매도', '풋 옵션', '콜 옵션')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '비용과 목적에 따라 적절한 파생 도구를 선택해야 합니다.'),
           NULL
       );

-- Q005. LINK: 헤징 실전 시나리오
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '헤징은 상황에 맞는 정교한 설계가 필요한 영역입니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH006_LS005', 'LV3_CH006_LS005_Q004', 'DRAG',
           'VIX 40 이상은 {{blank}} 구간으로 매수 기회를 탐색하고, VIX 15 이하는 {{blank}} 구간으로 리스크 관리를 검토해야 합니다.',
           JSON_OBJECT('choices', JSON_ARRAY('패닉(과매도)', '낙관(과매수)', '중립')),
           JSON_OBJECT('correct', JSON_ARRAY(0, 1), 'explanation', '공포 지수는 시장의 과열과 냉각을 판단하는 훌륭한 역발상 지표입니다.'),
           NULL
       );

-- Q005. LINK: 변동성 지수와 투자 전략
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           ...
           JSON_OBJECT('correct', JSON_OBJECT('L1', 'R1', 'L2', 'R2', 'L3', 'R3', 'L4', 'R4'), 'explanation', '변동성을 측정할 수 있으면 시장의 공포를 수익으로 바꿀 수 있습니다.'),
           NULL
       );
...
INSERT INTO learning_question (lesson_id, question_id, question_type, question_text, options, answer, image)
VALUES (
           'LV3_CH010_LS003', 'LV3_CH010_LS003_Q001', 'CONCEPT',
