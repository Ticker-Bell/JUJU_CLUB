...
<style>
    ...
    .corpo-card:hover {
        ...
        box-shadow: 0 8px 24px rgba(107, 91, 255, 0.15);
        border-color: #6b5bff;
    }
    ...
    .corpo-card-badge {
        background: linear-gradient(135deg, #6b5bff, #8b7bff);
        color: white;
        padding: 4px 12px;
        border-radius: 20px;
        font-size: 11px;
    ...
    @keyframes pulse {
        0% {
            box-shadow: 0 0 0 0 rgba(94, 69, 235, 0.5);
        }
        70% {
            box-shadow: 0 0 0 8px rgba(94, 69, 235, 0);
        }
        100% {
            box-shadow: 0 0 0 0 rgba(94, 69, 235, 0);
        }
    }
...
<div class="corpo-info-wrapper">
    ...
    <div class="corpo-card">
        <div class="corpo-card-header">
            ...
            <span class="update-time gray">마지막 갱신: <span id="update_time">-</span></span>
        </div>
        <div class="corpo-info-grid">
            <div class="corpo-info-item">
