...
<div class="ranking-wrapper" id="rankingMainContent">
    <div id="leftAnimZone">
        ...
        <div class="trophy-wrap">
            <div id="trophy-1" class="trophy silver">
                ...
                <div class="mt-3 text-[13px] font-black text-gray-600 trophy-name"
                     id="trophy-name-1"></div>
            </div>

            <div id="trophy-0" class="trophy gold active">
                <i data-lucide="trophy" class="w-full h-auto text-color"></i>
                <div class="mt-3 text-[13px] font-black text-gray-600 trophy-name"
                     id="trophy-name-0"></div>
            </div>

            <div id="trophy-2" class="trophy bronze">
                <i data-lucide="trophy" class="w-full h-auto text-color"></i>
                <div class="mt-3 text-[13px] font-black text-gray-600 trophy-name"
                     id="trophy-name-2"></div>
            </div>
        </div>


        <div class="portfolio-slider">
            <button type="button" class="nav-btn prev" id="prevBtn"><i
                        ...
                        <div class="card-content">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-gray-50 p-4 rounded-2xl">
                                    <div class="text-[10px] text-gray-400 font-bold mb-1 uppercase">
                                        총 보유자산
                                    </div>
                                    <div id="card-asset"
                                         class="text-[16px] font-black text-gray-900"></div>
                                </div>
                                <div class="bg-gray-50 p-4 rounded-2xl">
                                    <div class="text-[10px] text-gray-400 font-bold mb-1 uppercase">
                                        레슨 진행 수
                                    ...
                                    <div id="card-lesson"
                                         class="text-[16px] font-black text-red-500">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <button type="button" class="nav-btn next" id="nextBtn"><i
    ...
    <div id="rightDataZone">
        <section
                class="web-card p-5 border border-gray-100 rounded-2xl shadow-sm bg-white shrink-0">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="flex items-baseline gap-1">
                            <span id="my-rank-val"
                                  class="text-3xl font-black text-gray-900 leading-none">${rankingInfo.userAssetRank}</span>
                            <span class="text-[12px] font-bold text-gray-300">/ <fmt:formatNumber
                                    value="${rankingInfo.totUserCnt}"/></span>
                        </div>
                    </div>
                </div>
                <div class="h-10 w-[1px] bg-gray-100"></div>
                <div class="flex-1 pl-2">
                    <div id="my-main-label" class="text-[11px] font-bold text-gray-400 mb-1">총
                        보유자금
                    </div>
                    <div id="my-main-val" class="text-2xl font-black text-indigo-600 leading-none">₩
                        <fmt:formatNumber value="${rankingInfo.cashBalance}"/></div>
                </div>
            </div>
        </section>

        <section
                class="web-card flex-1 flex flex-col border border-gray-100 rounded-2xl shadow-sm bg-white overflow-hidden">
            <div class="p-4 border-b border-gray-50 bg-gray-50/30 flex flex-col gap-2">
                ...
                <div class="relative flex items-center gap-6 mt-2 border-b border-gray-200">
                    <button id="tab-asset" class="rank-tab-btn active"
                            onclick="switchRankTab('asset')">총 보유자금
                    </button>
                    <button id="tab-profit" class="rank-tab-btn" onclick="switchRankTab('profit')">
                        총 진행레슨 수
                    </button>
            ...
            <div class="flex-1 overflow-y-auto relative">
                <table id="table-asset"
                       class="rank-table w-full text-left transition-opacity duration-300">
                    <colgroup>
                    ...
                    <c:forEach var="row" items="${rankingInfo.rankingBorardListOBA}">
                        <tr class="
                            ...
                            <td class="py-2.5 px-4 pr-6 text-right font-bold text-sm text-gray-600">
                                ₩ <fmt:formatNumber value="${row.cashBalance}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                                ...
                                <td class="py-2.5 px-4 font-black text-sm">
                                    <div class="rank-user">
                                        <img class="rank-avatar"
                                             ...
                                             loading="lazy"
                                             onerror="this.onerror=null; this.style.display='none'; this.nextElementSibling.style.display='flex';"/>
                                        <div class="rank-avatar-fallback" style="display:none;">?
                                        </div>
                                        <span>${row.userName}</span>
                                    </div>
                                </td>
